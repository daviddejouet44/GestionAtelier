...
public static class BackendUtils
{
    ...
    public static void UpsertFabrication(FabricationSheet sheet)
    {
        ...
        var doc = new BsonDocument
        {
            ...
            ["dateReceptionSouhaitee"] = sheet.DateReceptionSouhaitee == null ? BsonNull.Value : (BsonValue)sheet.DateReceptionSouhaitee.Value,
    ...
    public static FabricationSheet? BsonDocToFabricationSheet(BsonDocument d)
    {
        ...
        return new FabricationSheet
        {
            ...
            DateReception         = d.Contains("dateReception")         && d["dateReception"]         != BsonNull.Value ? (DateTime?)d["dateReception"].ToUniversalTime()         : null,
            DateReceptionSouhaitee = d.Contains("dateReceptionSouhaitee") && d["dateReceptionSouhaitee"] != BsonNull.Value ? (DateTime?)d["dateReceptionSouhaitee"].ToUniversalTime() : null,
